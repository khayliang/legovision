...
export default () => {
  ...
  const getChanges = (oldArray: VideoNameInfo[], newArray: VideoNameInfo[]): VideoNameInfo[] => {
  ...
  return (
    <div className={styles.mainDiv}>
      <UploadModal onOk={handleOk} onCancel={handleCancel} visible={isModalVisible}/>
