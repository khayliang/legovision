...
export default () => {
  ...
  return (
    <div className={styles.mainDiv}>
      ...
      <Divider/>
      <ReactPlayer style={{backgroundColor: 'black'}} onPlay={onPlayPause} onPause={onPlayPause} onProgress={onProgressCallback} controls={true} url={[{src: `http://0.0.0.0:5000/video?name=${videoName}`, type: 'video/webm'}]} />
      </div>
